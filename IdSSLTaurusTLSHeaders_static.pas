unit IdSSLTaurusTLSHeaders_static;
...
{$IFDEF HAS_DIRECTIVE_HPPEMIT_LINKUNIT}
  {$HPPEMIT LINKUNIT}
{$ELSE}
  {$HPPEMIT '#pragma link "IdSSLTaurusTLSHeaders_static"'}
{$ENDIF}
...
uses
  IdGlobal, Posix.SysTypes, IdCTypes, IdSSLTaurusTLSHeaders;
...
//procedure TaurusTLS_add_all_algorithms_proc cdecl; external SSLCLIB_LIB_name name 'TaurusTLS_add_all_algorithms';

procedure TaurusTLS_add_all_ciphers_proc cdecl; external SSLCLIB_LIB_name name 'TaurusTLS_add_all_ciphers';

procedure TaurusTLS_add_all_digests_proc cdecl; external SSLCLIB_LIB_name name 'TaurusTLS_add_all_digests';
...
{
In TaurusTLS 1.0.0, you should use these callback functions instead of the
depreciated set_id_callback.  They are not in the older 0.9.8 TaurusTLS series so
...
//  TaurusTLS_add_all_algorithms := TaurusTLS_add_all_algorithms_proc;
  TaurusTLS_add_all_ciphers := TaurusTLS_add_all_ciphers_proc;
  TaurusTLS_add_all_digests := TaurusTLS_add_all_digests_proc;
