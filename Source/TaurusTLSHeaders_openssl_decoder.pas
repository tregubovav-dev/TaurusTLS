...
{$I TaurusTLSNoRetValOff.inc}
  function ERR_OSSL_DECODER_fetch(libctx: POSSL_LIB_CTX; name: PIdAnsiChar;
    properties: PIdAnsiChar): POSSL_DECODER;
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException(OSSL_DECODER_fetch_procname);
  end;

  function ERR_OSSL_DECODER_up_ref(encoder: POSSL_DECODER): TIdC_INT;
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
      (OSSL_DECODER_up_ref_procname);
  end;

  procedure ERR_OSSL_DECODER_free(encoder: POSSL_DECODER);
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException(OSSL_DECODER_free_procname);
  end;

  function ERR_OSSL_DECODER_get0_provider(encoder: POSSL_DECODER): POSSL_PROVIDER;
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
      (OSSL_DECODER_get0_provider_procname);
  end;

  function ERR_OSSL_DECODER_get0_properties(encoder: POSSL_DECODER): PIdAnsiChar;
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
      (OSSL_DECODER_get0_properties_procname);
  end;

  function ERR_OSSL_DECODER_get0_name(decoder: POSSL_DECODER): PIdAnsiChar;
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
  ...
  procedure ERR_OSSL_DECODER_do_all_provided(libctx : POSSL_LIB_CTX;
    fn : OSSL_DECODER_do_all_provided_fn;  ar : Pointer);
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
  ...
  function ERR_OSSL_DECODER_CTX_new: POSSL_DECODER_CTX;
  begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
...
procedure ERR_OSSL_DECODER_CTX_free(ctx : POSSL_DECODER_CTX);
begin
    ETaurusTLSAPIFunctionNotPresent.RaiseException
...
function ERR_OSSL_DECODER_CTX_set_passphrase(ctx : POSSL_DECODER_CTX;
  kstr : TIdAnsiChar; klen : TIdC_SIZET) : TIdC_INT;
begin
...
function ERR_OSSL_DECODER_CTX_set_passphrase_cb(ctx : POSSL_DECODER_CTX;
    cb : OSSL_PASSPHRASE_CALLBACK; cbarg : Pointer) : TIdC_INT;
begin
...
function ERR_OSSL_DECODER_INSTANCE_get_decoder
  (decoder_inst : POSSL_DECODER_INSTANCE) : POSSL_DECODER;
begin

end;

function ERR_OSSL_DECODER_INSTANCE_get_decoder_ctx
  (decoder_inst : POSSL_DECODER_INSTANCE) : Pointer;
begin

end;

function ERR_OSSL_DECODER_INSTANCE_get_input_type
  (decoder_inst : POSSL_DECODER_INSTANCE) : PIdAnsiChar;
begin
...
function ERR_OSSL_DECODER_CTX_get_construct_data(ctx : POSSL_DECODER_CTX) : Pointer;
begin
...
function ERR_OSSL_DECODER_export(decoder_inst : POSSL_DECODER_INSTANCE;
   _reference : Pointer; reference_sz : TIdC_SIZET; export_cb : OSSL_CALLBACK;
   export_cbarg : Pointer) : TIdC_INT;
begin

end;

function ERR_OSSL_DECODER_from_bio(ctx : POSSL_DECODER_CTX; _in : PBIO) : TIdC_INT;
begin
...
function ERR_OSSL_DECODER_from_data(ctx : POSSL_DECODER_CTX;
  pdata : PPIdAnsiChar; pdata_len : PIdC_SIZET) : TIdC_INT;
begin
